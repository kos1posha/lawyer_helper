...
class Ui_EditAddictionsWindow(object):
    def setupUi(self, EditAddictionsWindow):
        ...
        QWidget.setTabOrder(self.le_af_price_text, self.le_coef_agent)
        ...
        QWidget.setTabOrder(self.cmb_coef_service, self.le_coef_document)
        ...
        QWidget.setTabOrder(self.le_coef_document_issue_place, self.pb_coef_toggle_service)
        QWidget.setTabOrder(self.pb_coef_toggle_service, self.le_corf1_agent)
        ...
        QWidget.setTabOrder(self.cmb_corf1_service, self.le_corf2_agent)
        ...
        QWidget.setTabOrder(self.pb_corf2_toggle_service, self.pb_corf1_toggle_service)
        QWidget.setTabOrder(self.pb_corf1_toggle_service, self.tw_addictions)
