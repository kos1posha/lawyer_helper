...
class Ui_PrintDocxWindow(object):
    def setupUi(self, PrintDocxWindow):
        ...
        PrintDocxWindow.resize(500, 500)
        PrintDocxWindow.setMinimumSize(QSize(500, 500))
        icon = QIcon()
        ...
        self.gl_main.addWidget(self.w_contract, 5, 0, 1, 1)
        ...
        self.gl_main.addWidget(self.w_coef, 7, 0, 1, 1)
        ...
        self.gl_main.addWidget(self.w_act, 6, 0, 1, 1)
        ...
        self.gl_main.addWidget(self.w_corf1, 8, 0, 1, 1)
        ...
        self.cmb_printers.setMaximumSize(QSize(16777215, 22))
        self.cmb_printers.setEditable(True)
        self.cmb_printers.setSizeAdjustPolicy(QComboBox.AdjustToMinimumContentsLengthWithIcon)
        self.cmb_printers.setDuplicatesEnabled(False)
        ...
        self.gl_main.addWidget(self.w_printers, 20, 0, 1, 2)
        ...
        self.gl_main.addWidget(self.w_corf2, 9, 0, 1, 1)

        self.cb_default_printer = QCheckBox(PrintDocxWindow)
        self.cb_default_printer.setObjectName(u"cb_default_printer")

        self.gl_main.addWidget(self.cb_default_printer, 19, 0, 1, 1)
        ...
        self.gl_main.addWidget(self.pb_print, 21, 0, 1, 2)

        self.l_choose_printer = QLabel(PrintDocxWindow)
        self.l_choose_printer.setObjectName(u"l_choose_printer")

        self.gl_main.addWidget(self.l_choose_printer, 18, 0, 1, 1)
        ...
        self.sb_contract_count.setMaximumSize(QSize(16777215, 18))

        self.gl_main.addWidget(self.sb_contract_count, 5, 1, 1, 1)
        ...
        self.sb_coef_count.setMaximumSize(QSize(16777215, 18))

        self.gl_main.addWidget(self.sb_coef_count, 7, 1, 1, 1)
        ...
        self.sb_corf1_count.setMaximumSize(QSize(16777215, 18))

        self.gl_main.addWidget(self.sb_corf1_count, 8, 1, 1, 1)
        ...
        self.sb_act_count.setMaximumSize(QSize(16777215, 18))

        self.gl_main.addWidget(self.sb_act_count, 6, 1, 1, 1)
        ...
        self.sb_corf2_count.setMaximumSize(QSize(16777215, 18))

        self.gl_main.addWidget(self.sb_corf2_count, 9, 1, 1, 1)

        self.pushButton_3 = QPushButton(PrintDocxWindow)
        self.pushButton_3.setObjectName(u"pushButton_3")

        self.gl_main.addWidget(self.pushButton_3, 2, 0, 1, 1)

        self.pushButton_2 = QPushButton(PrintDocxWindow)
        self.pushButton_2.setObjectName(u"pushButton_2")

        self.gl_main.addWidget(self.pushButton_2, 3, 0, 1, 1)

        self.pushButton = QPushButton(PrintDocxWindow)
        self.pushButton.setObjectName(u"pushButton")

        self.gl_main.addWidget(self.pushButton, 4, 0, 1, 1)

        self.pushButton_4 = QPushButton(PrintDocxWindow)
        self.pushButton_4.setObjectName(u"pushButton_4")

        self.gl_main.addWidget(self.pushButton_4, 1, 0, 1, 1)
    ...
    def retranslateUi(self, PrintDocxWindow):
        ...
        self.cb_default_printer.setText(QCoreApplication.translate("PrintDocxWindow", u"\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c \u043e\u0441\u043d\u043e\u0432\u043d\u043e\u0439 \u043f\u0440\u0438\u043d\u0442\u0435\u0440", None))
        ...
        self.pushButton_3.setText(QCoreApplication.translate("PrintDocxWindow", u"PushButton", None))
        self.pushButton_2.setText(QCoreApplication.translate("PrintDocxWindow", u"PushButton", None))
        self.pushButton.setText(QCoreApplication.translate("PrintDocxWindow", u"PushButton", None))
        self.pushButton_4.setText(QCoreApplication.translate("PrintDocxWindow", u"PushButton", None))
    # retranslateUi
